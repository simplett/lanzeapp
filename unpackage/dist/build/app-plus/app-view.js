...
var fYB=_n('image')
_rz(z,fYB,'src',22,bUB,eTB,gg)
_(oXB,fYB)
var cZB=_n('view')
_rz(z,cZB,'class',23,bUB,eTB,gg)
var h1B=_oz(z,24,bUB,eTB,gg)
_(cZB,h1B)
_(oXB,cZB)
var o2B=_n('view')
_rz(z,o2B,'class',25,bUB,eTB,gg)
var c3B=_n('view')
_rz(z,c3B,'class',26,bUB,eTB,gg)
var o4B=_oz(z,27,bUB,eTB,gg)
_(c3B,o4B)
_(o2B,c3B)
var l5B=_n('view')
_rz(z,l5B,'class',28,bUB,eTB,gg)
var a6B=_oz(z,29,bUB,eTB,gg)
_(l5B,a6B)
_(o2B,l5B)
_(oXB,o2B)
_(oVB,oXB)
...
var t9U=_mz(z,'input',['bindinput',10,'data-event-opts',1,'placeholder',2,'placeholderStyle',3,'value',4],[],e,s,gg)
_(a8U,t9U)
var e0U=_mz(z,'view',['bindtap',15,'class',1,'data-event-opts',2],[],e,s,gg)
_(a8U,e0U)
_(o4U,a8U)
var bAV=_n('view')
_rz(z,bAV,'class',18,e,s,gg)
var oBV=_mz(z,'view',['bindtap',19,'class',1,'data-event-opts',2],[],e,s,gg)
_(bAV,oBV)
_(o4U,bAV)
_(f1U,o4U)
}
...
var cFV=_mz(z,'swiper',['autoplay',26,'bindchange',1,'circular',2,'data-event-opts',3],[],e,s,gg)
var hGV=_v()
_(cFV,hGV)
var oHV=function(oJV,cIV,lKV,gg){
var tMV=_n('swiper-item')
var eNV=_mz(z,'image',['bindtap',34,'data-event-opts',1,'src',2],[],oJV,cIV,gg)
_(tMV,eNV)
_(lKV,tMV)
return lKV
}
hGV.wxXCkey=2
_2z(z,32,oHV,e,s,gg,hGV,'swiper','__i0__','id')
_(fEV,cFV)
var bOV=_n('view')
...
var oVV=_n('view')
_rz(z,oVV,'class',42,fSV,oRV,gg)
_(cTV,oVV)
return cTV
}
oPV.wxXCkey=2
_2z(z,40,xQV,e,s,gg,oPV,'swiper','index','index')
_(fEV,bOV)
_(oDV,fEV)
_(xYU,oDV)
var cWV=_n('view')
...
var o4V=_mz(z,'view',['bindtap',48,'class',1,'data-event-opts',2],[],t1V,aZV,gg)
var x5V=_n('view')
_rz(z,x5V,'class',51,t1V,aZV,gg)
var o6V=_n('image')
_rz(z,o6V,'src',52,t1V,aZV,gg)
_(x5V,o6V)
_(o4V,x5V)
var f7V=_n('view')
_rz(z,f7V,'class',53,t1V,aZV,gg)
var c8V=_oz(z,54,t1V,aZV,gg)
_(f7V,c8V)
_(o4V,f7V)
_(e2V,o4V)
return e2V
...
oXV.wxXCkey=2
_2z(z,46,lYV,e,s,gg,oXV,'row','index','index')
_(xYU,cWV)
var h9V=_n('view')
_rz(z,h9V,'class',55,e,s,gg)
var o0V=_n('image')
_rz(z,o0V,'src',56,e,s,gg)
_(h9V,o0V)
_(xYU,h9V)
var cAW=_n('view')
_rz(z,cAW,'class',57,e,s,gg)
var oBW=_n('view')
_rz(z,oBW,'class',58,e,s,gg)
var lCW=_oz(z,59,e,s,gg)
_(oBW,lCW)
_(cAW,oBW)
var aDW=_n('view')
_rz(z,aDW,'class',60,e,s,gg)
var tEW=_v()
_(aDW,tEW)
var eFW=function(oHW,bGW,xIW,gg){
var fKW=_mz(z,'view',['bindtap',65,'class',1,'data-event-opts',2],[],oHW,bGW,gg)
var cLW=_n('view')
_rz(z,cLW,'class',68,oHW,bGW,gg)
var oNW=_n('view')
_rz(z,oNW,'class',69,oHW,bGW,gg)
var cOW=_oz(z,70,oHW,bGW,gg)
_(oNW,cOW)
_(cLW,oNW)
var hMW=_v()
_(cLW,hMW)
if(_oz(z,71,oHW,bGW,gg)){hMW.wxVkey=1
var oPW=_n('view')
_rz(z,oPW,'class',72,oHW,bGW,gg)
var lQW=_n('view')
var aRW=_oz(z,73,oHW,bGW,gg)
_(lQW,aRW)
_(oPW,lQW)
var tSW=_oz(z,74,oHW,bGW,gg)
_(oPW,tSW)
var eTW=_n('view')
var bUW=_oz(z,75,oHW,bGW,gg)
_(eTW,bUW)
_(oPW,eTW)
var oVW=_oz(z,76,oHW,bGW,gg)
_(oPW,oVW)
var xWW=_n('view')
var oXW=_oz(z,77,oHW,bGW,gg)
_(xWW,oXW)
_(oPW,xWW)
_(hMW,oPW)
}
...
_(fKW,cLW)
var fYW=_n('view')
_rz(z,fYW,'class',78,oHW,bGW,gg)
var cZW=_n('view')
_rz(z,cZW,'class',79,oHW,bGW,gg)
var h1W=_oz(z,80,oHW,bGW,gg)
_(cZW,h1W)
_(fYW,cZW)
var o2W=_n('view')
_rz(z,o2W,'class',81,oHW,bGW,gg)
var c3W=_oz(z,82,oHW,bGW,gg)
_(o2W,c3W)
_(fYW,o2W)
_(fKW,fYW)
var o4W=_n('view')
_rz(z,o4W,'class',83,oHW,bGW,gg)
var l5W=_n('image')
_rz(z,l5W,'src',84,oHW,bGW,gg)
_(o4W,l5W)
_(fKW,o4W)
_(xIW,fKW)
return xIW
...
tEW.wxXCkey=2
_2z(z,63,eFW,e,s,gg,tEW,'row','index','index')
_(cAW,aDW)
_(xYU,cAW)
var a6W=_n('view')
...
var e8W=_n('image')
_rz(z,e8W,'src',87,e,s,gg)
_(t7W,e8W)
var b9W=_oz(z,88,e,s,gg)
_(t7W,b9W)
var o0W=_n('image')
_rz(z,o0W,'src',89,e,s,gg)
_(t7W,o0W)
_(a6W,t7W)
var xAX=_n('view')
_rz(z,xAX,'class',90,e,s,gg)
var oBX=_v()
_(xAX,oBX)
var fCX=function(hEX,cDX,oFX,gg){
var oHX=_mz(z,'view',['bindtap',95,'class',1,'data-event-opts',2],[],hEX,cDX,gg)
var lIX=_mz(z,'image',['mode',98,'src',1],[],hEX,cDX,gg)
_(oHX,lIX)
var aJX=_n('view')
_rz(z,aJX,'class',100,hEX,cDX,gg)
var tKX=_oz(z,101,hEX,cDX,gg)
_(aJX,tKX)
_(oHX,aJX)
var eLX=_n('view')
_rz(z,eLX,'class',102,hEX,cDX,gg)
var bMX=_n('view')
_rz(z,bMX,'class',103,hEX,cDX,gg)
var oNX=_oz(z,104,hEX,cDX,gg)
_(bMX,oNX)
_(eLX,bMX)
var xOX=_n('view')
_rz(z,xOX,'class',105,hEX,cDX,gg)
var oPX=_oz(z,106,hEX,cDX,gg)
_(xOX,oPX)
_(eLX,xOX)
_(oHX,eLX)
_(oFX,oHX)
...
oBX.wxXCkey=2
_2z(z,93,fCX,e,s,gg,oBX,'product','__i1__','goods_id')
_(a6W,xAX)
var fQX=_n('view')
_rz(z,fQX,'class',107,e,s,gg)
var cRX=_oz(z,108,e,s,gg)
_(fQX,cRX)
_(a6W,fQX)
_(xYU,a6W)
oZU.wxXCkey=1
